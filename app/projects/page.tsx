...
const ProjectsWrapper = dynamic(() => import('../../components/ProjectsList'))
                ...
                >
                    ...
                    <Flex pt={10} pb={5} alignItems="start" flexDir="column">
                        <StyledHeading fontSize={['22px', '26px']}>
                            ...
                            <Constant> projects</Constant>.<TextVariable>featured</TextVariable>
                        </StyledHeading>
                    </Flex>
                    ...
                    <Flex pt={10} pb={5} alignItems="start" flexDir="column">
                        <StyledHeading fontSize={['22px', '26px']}>
                            <Constant>projects</Constant>.<TextVariable>all</TextVariable>
                        </StyledHeading>
                    </Flex>
                    <ProjectsWrapper projects={projectsList.all} />
                    <Text my={4} fontSize={['16px', '20px']} textAlign="center">
                        <Constant>More coming soon</Constant>{' '}
                        <TextVariable>
                            <small>(I&apos;m still adding them)</small>
                        </TextVariable>
                    </Text>
                </Container>
            </main>
